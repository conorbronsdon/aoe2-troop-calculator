...
export const fortificationToGameId = {
  // Walls
  'palisade-wall': 72,
 ...
 * @param {string} fortificationId - Our internal fortification ID
 * @returns {number|null} The game building ID or null if not found
 */
export const getGameFortificationId = (fortificationId) =>
  fortificationToGameId[fortificationId] || null;

/**
 * Get the image path for a fortification
 * @param {string} fortificationId - Our internal fortification ID
 * @returns {string|null} The path to the fortification image or null if not found
 */
export const getFortificationImagePath = (fortificationId) => {
