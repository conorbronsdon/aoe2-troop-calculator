...
export const unitToGameId: Record<string, number> = {
  // Infantry line
  ...
  // Note: 'slinger' is defined above in "Other archers" section (line 41)
  ...
  // Note: 'winged-hussar' is defined above in "Scout line" section (line 49)
 ...
 * @param unitId - Our internal unit ID
 * @returns The game unit ID or null if not found
 */
export const getGameUnitId = (unitId: string): number | null => unitToGameId[unitId] || null;

/**
 * Get the image path for a unit
 * @param unitId - Our internal unit ID
 * @returns The path to the unit image
 */
export const getUnitImagePath = (unitId: string): string | null => {
