 ...
 */
export const unitIconComponents: Record<string, IconType> = {
  // Infantry line
 ...
 */
export const categoryIcons: Record<UnitCategory, IconType> = {
  Infantry: GiSwordman,
  Archer: GiBowArrow,
  Cavalry: GiHorseHead,
  Siege: GiCatapult,
 ...
 * @param category - Unit category (fallback)
 * @returns Icon component
 */
export const getUnitIcon = (unitId: string, category: UnitCategory): IconType =>
