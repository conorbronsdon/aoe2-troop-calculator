...
interface TechTreeRestriction {
  missingUnits: string[];
}

export const techTreeRestrictions: Record<string, TechTreeRestriction> = {
 ...
 * @returns True if the civilization can build this unit
 */
export const canCivBuildUnit = (civId: string, unitId: string): boolean => {
 ...
 * @param civId - Civilization ID
 * @returns Array of unit IDs that cannot be built
 */
export const getMissingUnitsForCiv = (civId: string): string[] => {
  if (civId === 'generic' || !civId) {
    return [];
  }
