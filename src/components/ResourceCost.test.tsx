...
import { ResourceCost as ResourceCostType } from '../types';

describe('ResourceCost', () => {
  const baseCost: ResourceCostType = {
    food: 60,
    wood: 20,
    gold: 0,
    stone: 0,
  ...
  const fullCost: ResourceCostType = {
    food: 100,
    wood: 50,
    gold: 75,
    stone: 25,
  ...
  describe('Basic rendering', () => {
    ...
    it('should render with only one resource', () => {
      const goldOnly: ResourceCostType = { food: 0, wood: 0, gold: 100, stone: 0 };
  ...
  describe('Discount display', () => {
    it('should show discounted price without strikethrough when showDiscount is false', () => {
      const discountedCost: ResourceCostType = { food: 50, wood: 20, gold: 0, stone: 0 };
    ...
    it('should not show discount for resources with same price', () => {
      const sameWoodCost: ResourceCostType = { food: 50, wood: 20, gold: 0, stone: 0 };
      const { container } = render(
    ...
    it('should handle multiple discounted resources', () => {
      const multiDiscount: ResourceCostType = { food: 80, wood: 40, gold: 60, stone: 20 };
      const originalCost: ResourceCostType = { food: 100, wood: 50, gold: 75, stone: 25 };
  ...
  describe('Edge cases', () => {
    it('should handle all zero costs', () => {
      const zeroCost: ResourceCostType = { food: 0, wood: 0, gold: 0, stone: 0 };
    ...
    it('should handle very large numbers', () => {
      const largeCost: ResourceCostType = {
        food: 999999,
        wood: 999999,
        gold: 999999,
        stone: 999999,
