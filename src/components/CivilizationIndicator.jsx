...
export default function CivilizationIndicator() {
  ...
  return (
    <div className={`rounded-lg shadow-lg p-4 mb-6 border-2 transition-all duration-300 ${
      isGeneric
          ...
          <div>
            <div className="flex items-center gap-2">
              <h3 className={`text-xl font-bold ${
                isGeneric ? 'text-gray-700' : 'text-blue-900'
              }`}>
                {appliedCiv.name}
              </h3>
              {!isGeneric && (
            ...
            <div className={`text-sm ${isGeneric ? 'text-gray-600' : 'text-blue-700'}`}>
              ...
              {!isGeneric && (
                <>
                  ...
                  <span>
                    {appliedCiv.bonuses.length} total bonus{appliedCiv.bonuses.length !== 1 ? 'es' : ''}
                  </span>
                  {activeBonusCount > 0 && (
                    <>
                      <span className="mx-2">•</span>
