...
export default function PresetSelector(): JSX.Element {
  ...
  const calculateTotalUnits = (composition: Record<string, number>): number => Object.values(composition).reduce((sum, qty) => sum + qty, 0);

  const calculateTotalCost = (composition: Record<string, number>): TotalCost => {
    const totals: TotalCost = { food: 0, wood: 0, gold: 0, stone: 0 };
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-4 mb-4">
        ...
        <div>
          ...
          <select
            ...
            onChange={(e: ChangeEvent<HTMLSelectElement>) => handlePresetChange(e.target.value)}
