...
/**
 * Tooltip Component
 * Shows a tooltip with content on hover
 */
const Tooltip: React.FC<Props> = ({ children, content, position = 'top' }) => {
  ...
  return (
    ...
    >
      ...
      {isVisible && (
        <div
          className={`absolute z-50 px-2 py-1 text-xs font-medium text-white bg-gray-900 dark:bg-gray-700 rounded shadow-lg whitespace-nowrap ${positionClasses[position]}`}
          role="tooltip"
        >
          {content}
          <div
