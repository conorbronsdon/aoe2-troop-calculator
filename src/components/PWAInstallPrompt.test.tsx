...
describe('PWAInstallPrompt', () => {
  ...
  describe('interactions', () => {
    ...
    it('should store dismissal timestamp in localStorage', () => {
      ...
      const storedTime = parseInt(
        (window.localStorage.setItem as Mock).mock.calls[0][1] as string,
        10
      );
  ...
  describe('dismissal persistence', () => {
    it('should not show prompt if dismissed within last 7 days', () => {
      ...
      (window.localStorage.getItem as Mock).mockReturnValue(oneDayAgo.toString());
    ...
    it('should show prompt if dismissed more than 7 days ago', () => {
      ...
      (window.localStorage.getItem as Mock).mockReturnValue(eightDaysAgo.toString());
