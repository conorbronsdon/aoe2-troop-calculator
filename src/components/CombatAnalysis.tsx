...
export default function CombatAnalysis(): React.ReactElement | null {
  const { state } = useArmy();
...
function ArmyCombatStatsContent(): React.ReactElement {
  return (
...
function CombatSimulatorContent(): React.ReactElement {
  return (
